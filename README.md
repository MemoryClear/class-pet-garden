...
- species.json 包含 Gen1~Gen8 共 166 条（含Mega/极巨化等形态），班级可抽取池为 Gen1（#001~#151）tier=1 的 **68 种**宝可梦
